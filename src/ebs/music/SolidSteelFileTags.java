 ...
 * Copyright (c) 2013
 */
public class SolidSteelFileTags {
	...
	public SolidSteelFileTags(String fileName) {
	...
	public SolidSteelFileTags(String fileName, Date date, String name, String part1, String part2, String extension) {
		this(fileName);
